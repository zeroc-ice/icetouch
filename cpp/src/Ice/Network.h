...
public:
    ...
    //
    // The host used by the network proxy.
    //
    virtual std::string getHost() const = 0;

    //
    // The port number used by the network proxy.
    //
...
ICE_API std::string fdToString(SOCKET, const NetworkProxyPtr&, const std::string&, int);
