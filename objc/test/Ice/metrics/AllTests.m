...
metricsAllTests(id<ICECommunicator> communicator)
{
    ...
    test([[[clientMetrics getMetricsView:@"View" timestamp:&timestamp] objectForKey:@"ConnectionEstablishment"] count] == 0);

    [metrics ice_ping];
    
    test([[[clientMetrics getMetricsView:@"View" timestamp:&timestamp] objectForKey:@"ConnectionEstablishment"] count] 
                                                                                                                  == 1);
    ...
    [controller resume];
    test([[[clientMetrics getMetricsView:@"View" timestamp:&timestamp] objectForKey:@"ConnectionEstablishment"] count] == 1);
    m1 = [[[clientMetrics getMetricsView:@"View" timestamp:&timestamp] objectForKey:@"ConnectionEstablishment"] objectAtIndex:0];
    ...
    ICEObjectPrx* prx = [communicator stringToProxy:@"metrics:default -p 12010 -h localhost"];
    [prx ice_ping];
    ...
    test(m1.current <= 1 && m1.total == 1 && [m1.id_ isEqualToString:@"tcp -h localhost -p 12010"]);
