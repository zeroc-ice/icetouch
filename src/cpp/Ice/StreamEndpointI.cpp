...
IceObjC::StreamEndpointI::StreamEndpointI(const InstancePtr& instance, BasicStream* s) :
...
EndpointIPtr
IceObjC::StreamEndpointI::timeout(Int timeout) const
{
    if(timeout == _timeout)
    {
    ...
    {
        return new StreamEndpointI(_instance, _host, _port, _sourceAddr, timeout, _connectionId, _compress);
    }
}
...
IceObjC::StreamEndpointI::compress(bool compress) const
{
    ...
    {
        return new StreamEndpointI(_instance, _host, _port, _sourceAddr, _timeout, _connectionId, compress);
    }
}
...
{
    return new StreamEndpointI(_instance, _host, a->effectivePort(), _sourceAddr, _timeout, _connectionId, _compress);
}
...
void
IceObjC::StreamEndpointI::streamWriteImpl(BasicStream* s) const
{
...
{
    return new StreamEndpointI(_instance, host, port, _sourceAddr, _timeout, connectionId, _compress);
}
...
EndpointIPtr
IceObjC::StreamEndpointFactory::read(BasicStream* s) const
{
